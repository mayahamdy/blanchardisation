...
namespace Quantum {
  ...
  public enum ETurnEndReason : int {
    None,
    Time,
    Skip,
    Play,
  ...
  public enum ETurnStatus : int {
    None,
    Inactive,
    Active,
    Resolving,
  }
  public enum ETurnType : int {
    None,
    Waiting,
    Play,
    Countdown,
  ...
  public unsafe partial struct TurnData {
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        AssetRef.Serialize(&p->ConfigRef, serializer);
        EntityRef.Serialize(&p->Entity, serializer);
        FrameTimer.Serialize(&p->Timer, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial struct BallFields : Quantum.IComponent {
    ...
    [FieldOffset(16)]
    public FrameTimer EndOfMovementTimer;
    [FieldOffset(0)]
    public Int32 Score;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + HasCompletedCourse.GetHashCode();
        hash = hash * 31 + EndOfMovementTimer.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        QBoolean.Serialize(&p->HasCompletedCourse, serializer);
        AssetRef.Serialize(&p->Spec, serializer);
        FrameTimer.Serialize(&p->EndOfMovementTimer, serializer);
  ...
  public unsafe partial struct SpawnPoint : Quantum.IComponent {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 12269;
        hash = hash * 31 + (Int32)Type;
        hash = hash * 31 + IsAvailable.GetHashCode();
        hash = hash * 31 + Entity.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        serializer.Stream.Serialize((Int32*)&p->Type);
        QBoolean.Serialize(&p->IsAvailable, serializer);
        EntityRef.Serialize(&p->Entity, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct TurnContainer : Quantum.IComponentSingleton {
    public const Int32 SIZE = 40;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (TurnContainer*)ptr;
        Quantum.TurnData.Serialize(&p->CurrentTurn, serializer);
    }
  }
  public unsafe partial interface ISignalOnBallShot : ISignal {
    void OnBallShot(Frame f, EntityRef ball);
  }
  public unsafe partial interface ISignalOnTurnEnded : ISignal {
    void OnTurnEnded(Frame f, TurnData data, ETurnEndReason reason);
  }
  public unsafe partial interface ISignalOnStartCommandReceived : ISignal {
    void OnStartCommandReceived(Frame f, PlayerRef player);
  }
  public unsafe partial interface ISignalOnPlayCommandReceived : ISignal {
    void OnPlayCommandReceived(Frame f, PlayerRef player, PlayCommandData data);
  }
  public unsafe partial interface ISignalOnSkipCommandReceived : ISignal {
  ...
  public unsafe partial class Frame {
    private ISignalOnBallShot[] _ISignalOnBallShotSystems;
    private ISignalOnTurnEnded[] _ISignalOnTurnEndedSystems;
    private ISignalOnStartCommandReceived[] _ISignalOnStartCommandReceivedSystems;
    ...
    partial void InitGen() {
      ...
      _ISignalOnBallShotSystems = BuildSignalsArray<ISignalOnBallShot>();
      _ISignalOnTurnEndedSystems = BuildSignalsArray<ISignalOnTurnEnded>();
      _ISignalOnStartCommandReceivedSystems = BuildSignalsArray<ISignalOnStartCommandReceived>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.TurnContainer>();
      BuildSignalsArrayOnComponentRemoved<Quantum.TurnContainer>();
    ...
    public unsafe partial struct FrameSignals {
      public void OnBallShot(EntityRef ball) {
        var array = _f._ISignalOnBallShotSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnBallShot(_f, ball);
          }
        }
      }
      public void OnTurnEnded(TurnData data, ETurnEndReason reason) {
      ...
      public void OnStartCommandReceived(PlayerRef player) {
        var array = _f._ISignalOnStartCommandReceivedSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnStartCommandReceived(_f, player);
          }
        }
      }
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      typeRegistry.Register(typeof(Quantum.Actor), Quantum.Actor.SIZE);
      typeRegistry.Register(typeof(AssetGuid), AssetGuid.SIZE);
      typeRegistry.Register(typeof(AssetRef), AssetRef.SIZE);
      typeRegistry.Register(typeof(Quantum.BallFields), Quantum.BallFields.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.ESpawnPointType), 4);
      typeRegistry.Register(typeof(Quantum.ETurnEndReason), 4);
      typeRegistry.Register(typeof(Quantum.ETurnStatus), 4);
      typeRegistry.Register(typeof(Quantum.ETurnType), 4);
      ...
      typeRegistry.Register(typeof(Quantum.TurnContainer), Quantum.TurnContainer.SIZE);
      typeRegistry.Register(typeof(Quantum.TurnData), Quantum.TurnData.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 4)
        ...
        .Add<Quantum.Actor>(Quantum.Actor.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.BallFields>(Quantum.BallFields.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.SpawnPoint>(Quantum.SpawnPoint.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.TurnContainer>(Quantum.TurnContainer.Serialize, null, null, ComponentFlags.Singleton)
        .Finish();
    }
    [Preserve()]
    public static void EnsureNotStrippedGen() {
      ...
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.ESpawnPointType>();
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.ETurnEndReason>();
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.ETurnStatus>();
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.ETurnType>();
